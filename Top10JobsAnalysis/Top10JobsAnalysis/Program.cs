...
namespace Top10JobsAnalysis
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            //Reading input files
            String path = @"C:\Users\laerte\Desktop\Top10JobsAnalysis\inputsFromTestBed\";
            ...
            //per job
            path = @"C:\Users\laerte\Desktop\Top10JobsAnalysis\inputsFromTestBed\perJob\";
            for (int i = 1; i <= 10; i++)
            {
            ...
            //per worker
            path = @"C:\Users\laerte\Desktop\Top10JobsAnalysis\inputsFromTestBed\perWorker\";
            for (int i = 1; i <= 10; i++)
            {
                String[] averages = System.IO.File.ReadAllLines(path + "averages" + i.ToString() + ".txt");
                UserPrediction[] users = FillingOutUserPrediction(averages);
