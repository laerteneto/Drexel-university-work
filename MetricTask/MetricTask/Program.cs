    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            for (int i = 0; i < task_num; i++)
            {
                ...
                users_for_each_task = generate_random_Users(i);
        ...
        //randomly generating the n users (between 10 and 100) 
        public static int[] generate_random_Users(int n)
        {
            Random rnd = new Random(n);
            int num_users = rnd.Next(10, 101); //this is how many users are going to have ratings for a job
            int rand; 
