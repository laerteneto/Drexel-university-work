...
namespace MetricTask
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            tasks_table_task_name_index, task_table_task_name, task_table_metric_name,
            all_metrics_names, tasks_table_metric_value_index);
        ...
        public static int filling_out_metric_tasks_arrays(int T_len, int M_len,
            int[] task_table_task_name_index, String[] task_table_task_name, String[] task_table_metric_name,
            String[] all_metric_names, int[] task_table_metric_value_index)
        {
            int task_num = 1;
