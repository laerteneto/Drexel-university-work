...
namespace MetricTask
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            filling_out_metric_tasks_arrays(tm.Length, metrics.Length,
            ...
            write_array_to_file("job_names.txt", tasks_names, task_num);   
            ...
            write_matrix_to_file("X.txt", X, tasks.Length, metrics.Length);
            ...
            {
                users_for_each_task = generate_random_Users(i, users_num); //between 10 and (users_num/4)
                filling_out_Y(Y, users_for_each_task, i);
            }
        ...
        public static void filling_out_metric_tasks_arrays(int tasks_num, int metric_num,
        ...
        //function that return true if an array have a value (num)
        ...
        public static int[] generate_random_Users(int n, int total_user_num)
        {
        ...
        public static void filling_out_Y(int[,] Y, int[] users_for_each_task, int n)
        {
            Random rnd = new Random(n);
